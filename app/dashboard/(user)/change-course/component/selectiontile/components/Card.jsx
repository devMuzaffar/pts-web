...
const Card = ({ icon, title, desc, isSelected, onClick }) => {
  ...
  return (
    <div
      className={`font-semibold bg-white border-2 ${borderColor} relative rounded-lg flex flex-col items-center justify-center text-center gap-3 px-4 py-10`}
    ...
    >
      ...
      <img
        ...
        src="/dashboard/change-course/selected.png"
        alt=""
      />
    </div>
  );
